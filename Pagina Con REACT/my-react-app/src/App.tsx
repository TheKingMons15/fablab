  ...
  import Test from './pages/Herramientas/Test';
    import ProCalculo6 from './pages/Herramientas/Test/Calculos/ProCalculo6';
    import ProCalculo7 from './pages/Herramientas/Test/Calculos/ProCalculo7';
    import ProCalculo8 from './pages/Herramientas/Test/Calculos/ProCalculo8';
  import './App.css';
        ...
        <div className="app-container">
          ...
          <main className="mainContent">
            <Routes>
              ...
              <Route path="/test/Calculos/ProCalculo6" element={<ProCalculo6 />} />
              <Route path="/test/Calculos/pro-calculo-7" element={<ProCalculo7 />} />
              <Route path="/test/Calculos/pro-calculo-8" element={<ProCalculo8 />} />
            </Routes>
          </main>
